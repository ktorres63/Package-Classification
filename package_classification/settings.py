"""
Django settings for package_classification project.
...
SECRET_KEY = 'django-insecure-0_3o#^y0acfo=x9-ac!1q9_w=yk%a&3v(ko+%7w7!x$9tw(ejg'
...
ROOT_URLCONF = 'package_classification.urls'
